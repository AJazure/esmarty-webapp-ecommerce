...
class ProductoFactory extends Factory
{
    public function definition() {
        ...
        return [
        'codigo_producto' => $this->faker->random_int(), // Una linea aleatoria
        ...
        'stock_disponible' => $this->faker->random_int(),
        'stock_minimo' => $this->faker->random_int(),
        'stock_deseado' => $this->faker->random_int(),
