let configurationDataTable = {
        ...
        buttons:[ 
			{
				...
				exportOptions: {
					columns: [0, 1, 2, 3 ,5] // Índices de las columnas que quieres exportar (0-indexed)
				}
			},
			{
				extend:    'print',
	...
	language: {
		...
		"sInfo": "Pedidos del _START_ al _END_ de un total de _TOTAL_",
