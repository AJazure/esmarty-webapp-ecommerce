    ...
    <form action="{{ $producto->id ? route('producto.update', $producto) : route('producto.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control @error('codigo') is-invalid @enderror" id="codigo_producto" name="codigo_producto" value="{{ old('codigo_producto', optional($producto)->codigo_producto) }}">
                    @error('codigo')
...
{{--                     @error('categoria')
                ...
                <div class="col-sm-8">
                    <select id="id_marca" name="id_marca" class="form-control">
                        @foreach ($marcas as $marca)
                            <option {{ $producto->marca_id && $producto->marca_id == $marca->id ? 'selected': ''}} value="{{ $marca->id }}"> 
                                {{ $marca->descripcion }}
                            </option>
                        @endforeach
                    </select>                
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control @error('stock_disponible') is-invalid @enderror" id="stock_disponible" name="stock_disponible" value="{{ old('stock_disponible', optional($producto)->stock_disponible) }}">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control @error('stock_deseado') is-invalid @enderror" id="stock_deseado" name="stock_deseado" value="{{ old('stock_deseado', optional($producto)->stock_deseado) }}">
                    @error('stock_deseado')
                        <div class="invalid-feedback"> {{ $message }} </div>
                    @enderror
                </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control @error('stock_minimo') is-invalid @enderror" id="stock_minimo" name="stock_minimo" value="{{ old('stock_minimo', optional($producto)->stock_minimo) }}">
                    @error('stock_minimo')
                        <div class="invalid-feedback"> {{ $message }} </div>
                    @enderror
                </div>
